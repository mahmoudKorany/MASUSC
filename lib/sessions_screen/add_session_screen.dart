...
class AddSessionsScreen extends StatefulWidget {
  const AddSessionsScreen({super.key});

  @override
  State<AddSessionsScreen> createState() =>
      _AddSessionsScreenState();
}
...
class _AddSessionsScreenState extends State<AddSessionsScreen> {
  ...
  var committeeController = TextEditingController();
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ConditionalBuilder(
                            condition: state is! SubmitSessionsLoading && state is! GetSessionsLoading,
